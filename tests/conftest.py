...
def sample_protein_data():
    ...
    sample_names = [
        "Sample_A_1", "Sample_A_2", "Sample_A_3", 
        "Sample_B_1", "Sample_B_2", "Sample_B_3",
        "Sample_C_1", "Sample_C_2", "Sample_C_3",
        "Sample_D_1", "Sample_D_2", "Sample_D_3"
    ]
...
def standardized_protein_data():
    ...
    df = pd.DataFrame({
        ...
        # Sample columns:
        **{sample_name: data_matrix[:, i] for i, sample_name in enumerate(sample_names)}
    })
...
def sample_metadata():
    ...
    metadata_dict = {
        'Sample_A_1': {'Subject': 'S001', 'Group': 'Control', 'Visit': 'Baseline', 'DrugDose': 'Placebo'},
        'Sample_A_2': {'Subject': 'S002', 'Group': 'Control', 'Visit': 'Baseline', 'DrugDose': 'Placebo'},
        'Sample_A_3': {'Subject': 'S003', 'Group': 'Control', 'Visit': 'Baseline', 'DrugDose': 'Placebo'},
        'Sample_B_1': {'Subject': 'S001', 'Group': 'Control', 'Visit': 'Week4', 'DrugDose': 'Placebo'},
        'Sample_B_2': {'Subject': 'S002', 'Group': 'Control', 'Visit': 'Week4', 'DrugDose': 'Placebo'},
        'Sample_B_3': {'Subject': 'S003', 'Group': 'Control', 'Visit': 'Week4', 'DrugDose': 'Placebo'},
        'Sample_C_1': {'Subject': 'S004', 'Group': 'Treatment', 'Visit': 'Baseline', 'DrugDose': 'High'},
        'Sample_C_2': {'Subject': 'S005', 'Group': 'Treatment', 'Visit': 'Baseline', 'DrugDose': 'High'},
        'Sample_C_3': {'Subject': 'S006', 'Group': 'Treatment', 'Visit': 'Baseline', 'DrugDose': 'High'},
        'Sample_D_1': {'Subject': 'S004', 'Group': 'Treatment', 'Visit': 'Week4', 'DrugDose': 'High'},
        'Sample_D_2': {'Subject': 'S005', 'Group': 'Treatment', 'Visit': 'Week4', 'DrugDose': 'High'},
        'Sample_D_3': {'Subject': 'S006', 'Group': 'Treatment', 'Visit': 'Week4', 'DrugDose': 'High'},
    }
...
def sample_metadata_df():
    ...
    data = {
        'Sample': ['Sample_A_1', 'Sample_A_2', 'Sample_A_3', 'Sample_B_1', 
                   'Sample_B_2', 'Sample_B_3', 'Sample_C_1', 'Sample_C_2'],
        'Subject': ['S001', 'S002', 'S003', 'S001', 'S002', 'S003', 'S004', 'S005'],
        'Group': ['Control', 'Control', 'Control', 'Control', 
                  'Control', 'Control', 'Treatment', 'Treatment'],
        'Visit': ['Baseline', 'Baseline', 'Baseline', 'Week4', 
                  'Week4', 'Week4', 'Baseline', 'Baseline'],
        'DrugDose': ['Placebo', 'Placebo', 'Placebo', 'Placebo', 
                     'Placebo', 'Placebo', 'High', 'High']
    }
