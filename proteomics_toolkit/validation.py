...
def enhanced_sample_processing(
    ...
    if not validation_results['is_valid']:
        ...
        if strict_validation:
            ...
            print("⚠️  WARNING: Validation issues detected but continuing with available data:")
    ...
    print(f"✓ Enhanced sample processing complete: {len(final_sample_columns)} samples, {len(sample_metadata)} with metadata")
